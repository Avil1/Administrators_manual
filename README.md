...
- Служба мониторинга и логирования
  (взаимосвязь смотри Рисунок 1 — Схема развертывания системы)
---
...
3. Подключить сетевые кабели к коммутатору согласно схеме сети (Схема?)
...
*Таблица 8 — История изменений документа*
